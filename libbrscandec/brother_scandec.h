...
__int128_t ZEXT816(int64_t val);
__int128_t ZEXT416(int32_t val);
int64_t SUB168(__int128_t val1, int64_t val2);
__int128_t CONCAT88(int64_t val1, int64_t val2);
__int128_t movlpd(__int128_t val1, double val2);
